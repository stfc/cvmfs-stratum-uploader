# Django settings for CVMFS Stratum-0 Uploader project.
import os
...
TEMPLATE_CONTEXT_PROCESSORS = ("django.contrib.auth.context_processors.auth",
                               ...
                               # "uploader.core.context_processors.user_info",
                               # "uploader.core.context_processors.available_projects",
)
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'uploader/static/'),
)
...
MIDDLEWARE_CLASSES = (
    ...
    'uploader.custom_auth.middleware.NoLoginAdminRedirectMiddleware',
...
AUTHENTICATION_BACKENDS = (
    'uploader.custom_auth.backends.RemoteUserBackend',
