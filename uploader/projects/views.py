...
from uploader.core.decorators import class_view_decorator
from uploader.projects.forms import UploadFileForm, MakeDirectoryForm, RemoveDirectoryForm, RemoveFileForm
